...
import {
    ...
    Clock, // <-- Ícone adicionado para Controle de Ponto
    CalendarDays // <-- Ícone adicionado para Solicitações
} from 'lucide-react';
...
// --- Componente Sidebar (com novos itens) ---
    ...
    return (
      <aside className="w-64 bg-gradient-to-b from-neutral-900 to-black text-white p-6 flex flex-col justify-between h-screen fixed top-0 left-0 border-r border-neutral-700 z-50"> {/* Aumentado z-index */}
        ...
        <div>
          ...
          {/* === SEÇÃO RECURSOS HUMANOS ATUALIZADA === */}
          <div className='mb-6'>
